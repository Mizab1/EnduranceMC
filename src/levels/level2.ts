import { abs, clear, effect, execute, gamemode, give, MCFunction, Objective, playsound, raw, rel, say, scoreboard, Selector, sleep, tag, tellraw, title, tp, _ } from "sandstone";
import { clearedLevel1Tag, clearedLevel2Tag, failedTag, maxButtonPressed, noOfPlayer, tpLvl1, tpLvl2 } from "../constants";
